...
public class Noelle extends GenshinCharacter
{
	//女仆
	double DESF_100_BASE = 0.3;  //突破防御力加成
	public Noelle(){
		super.HP_BASE = 12071;           //基础生命
		super.ATK_BASE = 191;           //基础攻击力
	...
	public void counter_END()
	{
		...
		Defense_END = DEF_BASE * ( 1 + DEF_f100 + Defense_100_items + DESF_100_BASE + Sands_DEF_100 + Goblet_DEF_100 + Circlet_DEF_100 + DEF_100_W)
		            + DEF_f;
		...
		ATK_END = ( ATK_BASE + ATK_W ) * ( 1 + ATK_f100 + Sands_ATK_100 + Circlet_ATK_100 + Goblet_ATK_100 + ATK_W100 + ATK_100_items)
			+ Plume_ATK  //羽毛
			+ ATK_f  //小攻击
			+ Defense_END * ( 0.85/*13级大招攻击力转化*/ + 0.5/*六命*/);
