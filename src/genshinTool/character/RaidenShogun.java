...
public class RaidenShogun extends GenshinCharacter{
    //雷电芽衣
    public RaidenShogun(int lv){
        super.HP_BASE = 12907;     //基础生命
        super.ATK_BASE = 337;      //基础攻击力
        super.DMG_BASE = 0.5;//基础暴击伤害
        super.RATE_BASE = 0.05;  //基础暴击率
        super.DEF_BASE = 789;//防御
        super.Element_DMG_BASE = 0 ;
        super.Power_Efficiency_BASE = 1.32; //冲能
        super.Hit_DMG = 7.2144 + 0.07*60; //10级大招
    }
    ...
    public void counter_END()
    {
        ...
        ATK_END = ( ATK_BASE + ATK_W ) * ( 1 + 60*0.0131 + ATK_f100 + Sands_ATK_100 + Circlet_ATK_100 + Goblet_ATK_100 + ATK_W100 + ATK_100_items)
                + Plume_ATK  //羽毛
                + ATK_f
        /*+ HP_END * 0.012/*绿剑*/ ;  //小攻击
        ...
        ATK_DMG_END += (Power_Efficiency_END - 1) * 0.4;
