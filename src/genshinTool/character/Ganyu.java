...
public class Ganyu extends GenshinCharacter
{
	//甘雨

	public Ganyu(){
		super.HP_BASE = 9797;           //基础生命
		super.ATK_BASE = 335;           //基础攻击力
		super.DEF_BASE = 630;     //基础防御
		super.DMG_BASE = 0.884;    //基础暴击伤害
		super.RATE_BASE = 0.05+0.2;    //基础暴击率/天赋唯此一心加成
		super.Element_DMG_BASE = 0.2; //基础元素/物理伤害加成(固有天赋)
	}
	@Override
